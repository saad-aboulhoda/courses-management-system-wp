...
var searchResultContainer = document.querySelector("header .search ul");
var timeoutId;
searchInput.addEventListener("input", function () {
  ...
  timeoutId = setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetch(themosis.apiUrl + "/courses/search/".concat(value));
        case 2:
...
function inputFilter(inputId, list, item) {
  ...
  input.addEventListener("input", function (event) {
    ...
    items.forEach(function (element) {
      var title = element.querySelector(item);
...
// Taxonomies
document.querySelector("#taxSelector").addEventListener("input", function (event) {
